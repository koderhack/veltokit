...
`https://koderteam.github.io/veltokit/`
...
Draft release notes: link to [docs intro](https://koderteam.github.io/veltokit/docs/intro), install via SPM/CocoaPods, list `VeltoKit/` + sample app, disclaimer (unofficial BLE).
