...
```text
https://github.com/koderteam/veltokit
```
...
```swift
dependencies: [
  .package(url: "https://github.com/koderteam/veltokit", from: "0.1.0"),
],
targets: [
  .target(
    name: "YourApp",
...
Podspec: [`VeltoKit.podspec`](https://github.com/koderteam/veltokit/blob/main/VeltoKit.podspec) in the repo root.
